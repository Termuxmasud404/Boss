...
def banner():
	...
	prints(Panel(f'''{O2}               "SC FREE RASA PREMIUM | Masud Boss"{color_rich}
_____ _____________  ____________________ {H2}•{P2} Author : MASUD {color_rich}
╔══╗╔═╗╔══╗╔══╗{H2}•{P2} Author2: 8D{color_rich}
║╔╗║║║║║══╣║══╣    {H2}•{P2} Status : {H2}Premium{color_rich}
║╔╗║║║║╠══║╠══║    {H2}•{P2} Team   : I'm The Solo{color_rich}
